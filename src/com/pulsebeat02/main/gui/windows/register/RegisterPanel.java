...
import com.pulsebeat02.main.gui.windows.payment.Payment;
...
public class RegisterPanel {
	...
	static boolean[] allFilledIn = new boolean[3];
	...
	private void initialize() {
		...
		Logger.LOG.info("Opening Register Panel");
		...
		frmLogin.setBounds(100, 100, 500, 472);
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (Account.checkAccountDuplicate(username.getText(), email.getText())) {
					...
					if (!noSignUp) {
						...
						Logger.LOG.info("Account Added to All Accounts");
		...
		email.setBounds(160, 269, 295, 20);
		panel.add(email);
		email.setColumns(10);
		...
		passwordField.setBounds(160, 324, 295, 20);
		...
		username.setBounds(160, 215, 295, 20);
		panel.add(username);
