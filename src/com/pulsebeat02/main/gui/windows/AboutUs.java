...
public class AboutUs {
	...
	private void initialize() {
		...
		frmAboutUs.getContentPane().setBackground(Color.LIGHT_GRAY);
		frmAboutUs.setTitle("About Us");
		frmAboutUs.setIconImage(Toolkit.getDefaultToolkit().getImage(
				AboutUs.class.getResource("/com/pulsebeat02/main/resources/images/mainmenu/infoButton/infoicon.png")));
		frmAboutUs.setBounds(100, 100, 400, 250);
		...
		frmAboutUs.getContentPane().add(separator);
		...
		frmAboutUs.getContentPane().add(lblNewLabel_2);
