...
import com.pulsebeat02.main.gui.windows.CredentialsLoaded;
...
public class AccountSettings extends JPanel {
	...
	public AccountSettings(Account account) {
		...
		CustomJLabel lblChangePassword = new CustomJLabel(10, 175, 524, 27, "Change Password:", this, horizCenter,
		...
		CustomJLabel lblRetypeNewPassword = new CustomJLabel(10, 303, 237, 27, "Retype New Password to Confirm:",
				this, null, null, new Font("Segoe UI", Font.PLAIN, 15), null);
		...
		CustomJLabel lblBiography = new CustomJLabel(10, 340, 524, 27, "Biography (One Sentence):", this, null,
