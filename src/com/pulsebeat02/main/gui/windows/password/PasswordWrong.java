...
public class PasswordWrong implements WindowListener {
	...
	private JFrame frmPasswordIsWrong;

	static Timer timer;

	static int interval = (int) PasswordConfig.prop.get(0);
	...
	private void initialize() {
		...
		Logger.LOG.info("Opening Password Wrong Window");
		...
		timer.scheduleAtFixedRate(new TimerTask() {
			...
			public void run() {
				...
				if (interval == 0) {
					...
					PasswordWindow.isDisabled = false;
		...
		frmPasswordIsWrong.setIconImage(Toolkit.getDefaultToolkit().getImage(
				PasswordWrong.class.getResource("/com/pulsebeat02/main/resources/images/passwordWrongIcon.png")));
