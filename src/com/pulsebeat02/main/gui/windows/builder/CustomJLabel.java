package com.pulsebeat02.main.gui.windows.builder;
...
public class CustomJLabel extends JLabel {
	...
	public CustomJLabel(int x, int y, int width, int height, String text, JPanel panel, Object HorizAllignment, Object foreground,
			Object font, ImageIcon icon) {
