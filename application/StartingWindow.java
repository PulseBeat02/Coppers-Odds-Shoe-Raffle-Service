...
import com.pulsebeat02.shoeraffleservice.application.builder.CustomJLabel;
...
public class StartingWindow /* extends SwingWorker<Integer, Void> */ {
    ...
    JPanel shoes;
    JPanel myAccount;
    JPanel paymentHistory;
    JPanel decorativeBorder;

    JLayeredPane tips;
    JLayeredPane mainPane;

    JLabel Shoe1ChanceofWinning;
    JLabel Shoe2ChanceofWinning;
    JLabel Shoe3ChanceofWinning;

    public static Shoe[] shoesInGui = new Shoe[2];

    public JFrame frmShoeRafflePrize;
    ...
    int horizLeft = SwingConstants.LEFT;
     ...
     */
    public StartingWindow(Account acount) {
...
//		adThread.start();
	...
	frmShoeRafflePrize.setIconImage(Toolkit.getDefaultToolkit().getImage(StartingWindow.class
		.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/infoButton/infoicon.png")));
	...
	CustomJLabel lblNewLabel_6 = new CustomJLabel(20, 11, 45, 50, "", dashboard, null, null, null,
		new ImageIcon(StartingWindow.class
			.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/refresh-button.png")));
	...
	CustomJLabel lblNewLabel_7 = new CustomJLabel(20, 90, 45, 50, "", dashboard, null, null, null, new ImageIcon(
		StartingWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/logout.png")));
	...
	CustomJLabel label = new CustomJLabel(20, 175, 45, 50, "", dashboard, null, null, null, new ImageIcon(
		StartingWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/dollarbill.png")));
	...
	CustomJLabel lblNewLabel_11 = new CustomJLabel(10, 11, 58, 33, "", panel_1, null, null, null, new ImageIcon(
		StartingWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/shopping-cart.png")));
	...
	CustomJLabel label_2 = new CustomJLabel(10, 13, 46, 33, "", panel_6, null, null, null, new ImageIcon(
		StartingWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/tickets.png")));
	...
	CustomJLabel lblNewLabel_12 = new CustomJLabel(0, 12, 46, 37, "", panel_7, horizCenter, null, null,
		new ImageIcon(StartingWindow.class
			.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/running.png")));
	...
	CustomJLabel lblNewLabel_15 = new CustomJLabel(99, 12, 91, 34, "", panel_8, horizCenter, null, null,
		new ImageIcon(StartingWindow.class
			.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/account.png")));
	...
	CustomJLabel lblNewLabel_13 = new CustomJLabel(98, 11, 92, 35, "", panel_5, horizCenter, null, null,
		new ImageIcon(StartingWindow.class
			.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/wifi-connection-good.png")));
	...
	try {
		...
		@Override
		public void mouseClicked(MouseEvent e) {
		    ShoeRaffleService.service.getInstanceManager().SHOE_MENU = new ShoeMenu(account, shoesInGui[1]);
		}
	...
	lblImage_1.addMouseListener(new MouseAdapter() {
		...
		ShoeRaffleService.service.getInstanceManager().SHOE_MENU = new ShoeMenu(account, shoesInGui[0]);
	    }
	...
	try {
		...
		@Override
		public void mouseClicked(MouseEvent e) {
		    ShoeRaffleService.service.getInstanceManager().SHOE_MENU = new ShoeMenu(account, shoesInGui[2]);
		}
	...
	btnNewButton_1.addMouseListener(new MouseAdapter() {
		...
		try {
		    ShoeRaffleService.service.getInstanceManager().PAYMENT_TABLE = new PaymentTable(account);
		} catch (IOException e1) {
		    // TODO Auto-generated catch block
		    e1.printStackTrace();
		}
	...
	btnHelp.addMouseListener(new MouseAdapter() {
	    @Override
	    public void mouseClicked(MouseEvent e) {
		File htmlFile = new File(cwd + "/src/com/pulsebeat02/shoeraffleservice/resources/help.html");
		try {
	...
	btnNewButton_3.addMouseListener(new MouseAdapter() {
		...
		try {
		    ShoeRaffleService.service.getInstanceManager().REFRESH.start("account");
		} catch (IOException e1) {
		    // TODO Auto-generated catch block
		    e1.printStackTrace();
		}

		ShoeRaffleService.service.getInstanceManager().CREDENTIALS_LOADED = new CredentialsLoaded();
	...
	CustomJLabel lblNewLabel_1 = new CustomJLabel(10, 5, 46, 39, "", panel, null, null, null, new ImageIcon(
		StartingWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/copporsOdds.png")));
	...
	btnNewButton_4.addMouseListener(new MouseAdapter() {
	    @Override
	    public void mousePressed(MouseEvent e) {
		ShoeRaffleService.service.getInstanceManager().CHOOSE_MUSIC = new ChooseMusic(account);
	    }
	});
	ImageIcon image = new ImageIcon(
		StartingWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/music.jpg"));
	...
	CustomJLabel lblDashBoard = new CustomJLabel(10, 67, 160, 38, " Dashboard", welcomePanel, horizCenter, white,
		new Font("Segoe UI", Font.BOLD, 15), new ImageIcon(
			StartingWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/home.png")));
	...
	CustomJLabel lblShoes = new CustomJLabel(10, 115, 160, 38, " Shoes", welcomePanel, horizCenter, white,
		new Font("Segoe UI", Font.BOLD, 15), new ImageIcon(
			StartingWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/shoe.png")));
	...
	CustomJLabel lblPaymentHistory = new CustomJLabel(10, 164, 160, 38, " Payments", welcomePanel, horizCenter,
		white, new Font("Dialog", Font.BOLD, 15), new ImageIcon(
			StartingWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/money.png")));
	...
	lblAboutUs.addMouseListener(new MouseAdapter() {
	    @Override
	    public void mouseClicked(MouseEvent e) {
		ShoeRaffleService.service.getInstanceManager().ABOUT_US = new AboutUs();
	...
	if (!isConnected()) {
	    ...
	    lblNewLabel_13.setIcon(new ImageIcon(
		    StartingWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/no-wifi.png")));
	...
	// ShoeRaffleService.service.getInstanceManager().BUYING_TICKETS.account = account;

    }

    public void fontSelector(JLabel label) {
    ...
    public ImageIcon BlackAndWhite(ImageIcon icon) {
    ...
    public BufferedImage convertToBufferedImage(ImageIcon image) {
     ...
     * 
     * Random rand = new Random(); boolean random = rand.nextBoolean();
     * 
     * random = true;
     * 
