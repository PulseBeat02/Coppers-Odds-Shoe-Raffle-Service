...
public class PaymentExpired extends JInternalFrame {
	...
	JLabel lblNewLabel_1 = new JLabel(
		"<html>This means that you didn't pay for the raffle tickets within the 15 minutes given. Please either close this window and make a new Payment (the old Payment expired), or close this window and don't make a new payment. Thank you.");
