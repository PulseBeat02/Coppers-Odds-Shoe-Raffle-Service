...
import com.pulsebeat02.shoeraffleservice.application.paypal.ClientID_Secret;
import com.pulsebeat02.shoeraffleservice.application.raffles.RaffleTicket;
...
public class BuyingTickets {
	...
	btnNewButton.addActionListener(new ActionListener() {
		...
		for (int i = 0; i < raffles.size(); i++) {
		    ...
		    ShoeRaffleService.service.getInstanceManager().PICK_RANDOM_RAFFLE.allRaffles.add(raffles.get(i));
		...
		try {
		    ...
		    if (ShoeRaffleService.service.getInstanceManager().RUN_SCRIPT.checkApproval()) {
		        ...
		        com.pulsebeat02.shoeraffleservice.application.payment.Payment paymentFinal = new com.pulsebeat02.shoeraffleservice.application.payment.Payment(
		        ...
		        ShoeRaffleService.service.getInstanceManager().MANAGE_PAYMENTS.allPayments.put(paymentFinal.id, paymentFinal);
		    	...
		    	ShoeRaffleService.service.getInstanceManager().PICK_RANDOM_RAFFLE.allRaffles.add(raffle);
		        ...
		        ShoeRaffleService.service.getInstanceManager().PAYMENT_EXPIRED = new PaymentExpired();
