package com.pulsebeat02.shoeraffleservice.application.review;
...
public class RateApplication extends JDialog {
	...
	label.setIcon(new ImageIcon(ScaledImage(
		new ImageIcon(RateApplication.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/star.png"))
			.getImage(),
