...
import com.pulsebeat02.shoeraffleservice.application.payment.Payment;
...
public class RegisterPanel {
	...
	lblNewLabel.setIcon(new ImageIcon(
		RegisterPanel.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/register/register.png")));
	...
	lblEmail.setIcon(new ImageIcon(
		RegisterPanel.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/register/email.png")));
	...
	lblPassword.setIcon(new ImageIcon(
		RegisterPanel.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/register/password.png")));
	...
	btnSignUp.addMouseListener(new MouseAdapter() {
		...
		if (!checkValues()) {
		    ...
		    ShoeRaffleService.service.getInstanceManager().MISSING_FIELDS = new MissingFields();
		} else {
		...
		try {
			...
			if (!noSignUp) {
			    ...
			    Payment payment = new Payment("Example Payment",
				    ...
				    "Made Free Account, No Charges", "Don't worry about this!", 0.00, null, true,
				    account);
			    ShoeRaffleService.service.getInstanceManager().MANAGE_PAYMENTS.allPayments.put(payment.id, payment);
			    ShoeRaffleService.service.getInstanceManager().ACCOUNT_CREATED = new AccountCreated();
	...
	lblUsername.setIcon(new ImageIcon(
		RegisterPanel.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/register/avatar.png")));
