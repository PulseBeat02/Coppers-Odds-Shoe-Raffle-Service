...
public class PasswordWindow {
	...
	frmEnterPassword.setIconImage(Toolkit.getDefaultToolkit()
		.getImage(PasswordWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/password.png")));
	...
	lblNewLabel.setIcon(
		new ImageIcon(PasswordWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/password.png")));
