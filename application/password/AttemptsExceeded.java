...
public class AttemptsExceeded {
	...
	public static void start() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AttemptsExceeded window = new AttemptsExceeded();
	...
	private void initialize() {
		...
		frmPasswordIsDisabled.setIconImage(Toolkit.getDefaultToolkit().getImage(
				AttemptsExceeded.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/disabled.png")));
