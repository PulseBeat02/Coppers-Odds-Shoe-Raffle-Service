package com.pulsebeat02.shoeraffleservice.application.splash;
...
import com.pulsebeat02.shoeraffleservice.util.SplashScreenLoading;
...
public class LoadingScreen {
	...
	this.frmCoppersOddsIs.setIconImage(Toolkit.getDefaultToolkit()
		.getImage(LoadingScreen.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/loadingscreen/co1.PNG")));
	...
	lblNewLabel.setIcon(new ImageIcon(
		LoadingScreen.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/loadingscreen.gif")));
