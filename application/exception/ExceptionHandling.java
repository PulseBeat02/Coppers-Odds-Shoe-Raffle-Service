package com.pulsebeat02.shoeraffleservice.application.exception;
...
public class ExceptionHandling {
	...
	this.frmError.setIconImage(Toolkit.getDefaultToolkit().getImage(
		ExceptionHandling.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/passwordWrongIcon.png")));
