...
public class BuyingRaffleTickets {
    ...
    public BuyingRaffleTickets(Account a, Shoe s) {
	EventQueue.invokeLater(new Runnable() {
	    public void run() {
		try {
		    initialize(a, s, s.shoeName, s.totalRaffles, s.totalRaffles);
    ...
    private void initialize(Account a, Shoe s, String shoeName, int totalTickets, int boughtTickets) {
	...
	this.frmRaffleTickets.setIconImage(Toolkit.getDefaultToolkit().getImage(
		BuyingRaffleTickets.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/tickets.png")));
	...
	btnNewButton.addActionListener(new ActionListener() {
		...
		ShoeRaffleService.service.getInstanceManager().BUYING_TICKETS = new BuyingTickets(s, a);
	    }
	});
