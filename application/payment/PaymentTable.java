...
public class PaymentTable {
    ...
    public PaymentTable(Account a) throws IOException {
	...
	f.setIconImage(Toolkit.getDefaultToolkit().getImage(
		PaymentTable.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/dollarbill.png")));
	...
	ShoeRaffleService.service.getInstanceManager().STARTING_WINDOW.frmShoeRafflePrize.setEnabled(true);
	ShoeRaffleService.service.getInstanceManager().STARTING_WINDOW.frmShoeRafflePrize.setCursor(Cursor.getDefaultCursor());
	...
	Set<Entry<String, Payment>> set = ShoeRaffleService.service.getInstanceManager().MANAGE_PAYMENTS.allPayments.entrySet();
