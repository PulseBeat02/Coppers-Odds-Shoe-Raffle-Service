...
public class ResetPasscode extends JDialog {
	...
	this.setIconImage(Toolkit.getDefaultToolkit()
		.getImage(ResetPasscode.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/password.png")));
	...
	this.okButton.addMouseListener(new MouseAdapter() {
		...
		if (!isDisabled) {
		    ...
		    ShoeRaffleService.service.getInstanceManager().ENTER_CODE = new EnterCode();
