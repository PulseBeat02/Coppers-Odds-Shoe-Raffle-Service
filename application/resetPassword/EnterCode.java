...
public class EnterCode extends JDialog {
	...
	this.setIconImage(Toolkit.getDefaultToolkit()
		.getImage(EnterCode.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/password.png")));
	...
	okButton.addMouseListener(new MouseAdapter() {
		...
		if (textField.getText().equals(String.valueOf(code))) {
		    ...
		    ShoeRaffleService.service.getInstanceManager().CHANGE_PASSWORD = new ChangePassword(null);
