...
public class ChangeSettings {
	...
	this.frame.setIconImage(Toolkit.getDefaultToolkit().getImage(
		StartingWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/account.png")));
	...
	TabSelection location = new TabSelection("Location", Toolkit.getDefaultToolkit().getImage(
		StartingWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/location.png")));
	...
	TabSelection notifications = new TabSelection("Notifications", Toolkit.getDefaultToolkit().getImage(
		StartingWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/bell.png")));
	...
	TabSelection uninstall = new TabSelection("Uninstall", Toolkit.getDefaultToolkit().getImage(
		StartingWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/uninstall.png")));
	...
	TabSelection support = new TabSelection("Support", Toolkit.getDefaultToolkit().getImage(
		StartingWindow.class.getResource("/com/pulsebeat02/shoeraffleservice/resources/images/mainmenu/support.png")));
